...
impl<T: frame_system::Config> pallet_asset_registry::WeightInfo for HydraWeight<T> {
	...
	fn register() -> Weight {
		...
		Weight::from_parts(45_472_000, 4087)
	...
	fn update() -> Weight {
		...
		//  Measured:  `617`
		//  Estimated: `4087`
		// Minimum execution time: 47_048_000 picoseconds.
		Weight::from_parts(47_462_000, 4087)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn register_external() -> Weight {
		...
		Weight::from_parts(34_072_000, 4087)
	...
	fn ban_asset() -> Weight {
		...
		Weight::from_parts(22_148_000, 3590)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	...
	fn unban_asset() -> Weight {
		...
		Weight::from_parts(18_323_000, 3485)
