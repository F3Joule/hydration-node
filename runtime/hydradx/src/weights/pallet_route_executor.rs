...
impl<T: frame_system::Config> pallet_route_executor::WeightInfo for HydraWeight<T> {
	...
	fn skip_ed_handling_for_trade_with_insufficient_assets() -> Weight {
		...
		Weight::from_parts(21_307_000, 3590)
	...
	fn calculate_and_execute_sell_in_lbp(c: u32, ) -> Weight {
		...
		//  Measured:  `3885`
		//  Estimated: `13905`
		// Minimum execution time: 431_319_000 picoseconds.
		Weight::from_parts(434_008_444, 13905)
			// Standard Error: 1_414_899
			.saturating_add(Weight::from_parts(71_136_555, 0).saturating_mul(c.into()))
	...
	fn calculate_and_execute_buy_in_lbp(c: u32, b: u32, ) -> Weight {
		...
		//  Estimated: `6190 + b * (7749 ±0)`
		// Minimum execution time: 117_433_000 picoseconds.
		Weight::from_parts(118_098_000, 6190)
			// Standard Error: 3_717_209
			.saturating_add(Weight::from_parts(3_514_060, 0).saturating_mul(c.into()))
			// Standard Error: 8_159_407
			.saturating_add(Weight::from_parts(325_750_292, 0).saturating_mul(b.into()))
	...
	fn set_route_for_xyk() -> Weight {
		...
		//  Measured:  `5319`
		//  Estimated: `26820`
		// Minimum execution time: 411_980_000 picoseconds.
		Weight::from_parts(411_980_000, 26820)
	...
	fn force_insert_route() -> Weight {
		...
		Weight::from_parts(32_318_000, 0)
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_route() -> Weight {
		...
		Weight::from_parts(11_139_000, 3555)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `EmaOracle::Oracles` (r:2 w:0)
	/// Proof: `EmaOracle::Oracles` (`max_values`: None, `max_size`: Some(177), added: 2652, mode: `MaxEncodedLen`)
	fn get_oracle_price_for_xyk() -> Weight {
		...
		Weight::from_parts(33_182_000, 6294)
	...
	fn get_oracle_price_for_omnipool() -> Weight {
		...
		//  Measured:  `1840`
		//  Estimated: `11598`
		// Minimum execution time: 59_186_000 picoseconds.
		Weight::from_parts(59_186_000, 11598)
	...
	fn calculate_spot_price_with_fee_in_lbp() -> Weight {
		...
		Weight::from_parts(59_361_000, 6190)
