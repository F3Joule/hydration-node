...
impl<T: frame_system::Config> pallet_ema_oracle::WeightInfo for HydraWeight<T> {
	...
	fn add_oracle() -> Weight {
		...
		Weight::from_parts(31_241_000, 2126)
	...
	fn remove_oracle() -> Weight {
		...
		//  Measured:  `1888`
		//  Estimated: `7406`
		// Minimum execution time: 47_884_000 picoseconds.
		Weight::from_parts(48_354_000, 7406)
	...
	fn on_finalize_no_entry() -> Weight {
		...
		Weight::from_parts(4_855_000, 7406)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `EmaOracle::Accumulator` (r:1 w:1)
	/// Proof: `EmaOracle::Accumulator` (`max_values`: Some(1), `max_size`: Some(5921), added: 6416, mode: `MaxEncodedLen`)
	...
	fn on_finalize_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(24_939_924, 7406)
			// Standard Error: 17_795
			.saturating_add(Weight::from_parts(36_128_785, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn on_trade_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(37_505_220, 7406)
			// Standard Error: 5_453
			.saturating_add(Weight::from_parts(501_684, 0).saturating_mul(b.into()))
	...
	fn on_liquidity_changed_multiple_tokens(b: u32, ) -> Weight {
		...
		//  Measured:  `1743 + b * (162 ±0)`
		//  Estimated: `7406`
		// Minimum execution time: 36_096_000 picoseconds.
		Weight::from_parts(37_615_120, 7406)
			// Standard Error: 5_501
			.saturating_add(Weight::from_parts(495_668, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_entry() -> Weight {
		...
		Weight::from_parts(33_432_000, 6294)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn update_bifrost_oracle() -> Weight {
		...
		Weight::from_parts(58_553_000, 7406)
