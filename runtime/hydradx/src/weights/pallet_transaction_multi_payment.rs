...
impl<T: frame_system::Config> pallet_transaction_multi_payment::WeightInfo for HydraWeight<T> {
	...
	fn add_currency() -> Weight {
		...
		Weight::from_parts(28_869_000, 3493)
	...
	fn remove_currency() -> Weight {
		...
		Weight::from_parts(28_360_000, 3493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn set_currency() -> Weight {
		...
		Weight::from_parts(39_365_000, 3493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_oracle_price() -> Weight {
		...
		//  Measured:  `3221`
		//  Estimated: `27510`
		// Minimum execution time: 106_216_000 picoseconds.
		Weight::from_parts(107_137_000, 27510)
	...
	fn reset_payment_currency() -> Weight {
		...
		Weight::from_parts(31_169_000, 4087)
	...
	fn withdraw_fee() -> Weight {
		...
		//  Measured:  `4234`
		//  Estimated: `11322`
		// Minimum execution time: 286_914_000 picoseconds.
		Weight::from_parts(288_803_000, 11322)
