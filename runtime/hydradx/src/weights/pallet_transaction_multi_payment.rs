...
impl<T: frame_system::Config> pallet_transaction_multi_payment::WeightInfo for HydraWeight<T> {
	...
	fn add_currency() -> Weight {
		...
		Weight::from_parts(27_696_000, 3493)
	...
	fn remove_currency() -> Weight {
		...
		Weight::from_parts(27_801_000, 3493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn set_currency() -> Weight {
		...
		Weight::from_parts(38_367_000, 3493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_oracle_price() -> Weight {
		...
		Weight::from_parts(105_746_000, 27510)
	...
	fn reset_payment_currency() -> Weight {
		...
		Weight::from_parts(30_576_000, 4087)
	...
	fn withdraw_fee() -> Weight {
		...
		//  Measured:  `4234`
		//  Estimated: `11322`
		// Minimum execution time: 289_440_000 picoseconds.
		Weight::from_parts(290_373_000, 11322)
